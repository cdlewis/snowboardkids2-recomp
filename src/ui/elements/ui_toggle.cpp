...
namespace {
    ...
    Toggle::Toggle(Element *parent) : Element(parent, Events(EventType::Click, EventType::Focus, EventType::Hover, EventType::Enable), "button") {
        ...
        set_opacity(0.9f);
        hover_style.set_background_color(Color{ 23, 214, 232, 77 });
        hover_style.set_opacity(1.0f);
        focus_style.set_background_color(Color{ 23, 214, 232, 77 });
        focus_style.set_opacity(1.0f);
        checked_hover_style.set_background_color(Color{ 23, 214, 232, 77 });
        checked_hover_style.set_opacity(1.0f);
        checked_focus_style.set_background_color(Color{ 23, 214, 232, 77 });
        checked_focus_style.set_opacity(1.0f);
