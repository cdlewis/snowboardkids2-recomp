...
void apply() {
    ...
    frontend_theme.prompt.overlay.set_background_color(Color{ 190, 184, 219, 25 });
    frontend_theme.prompt.content.set_background_color(Color{ 85, 145, 223, 255 });
    frontend_theme.prompt.content.set_border_color(Color{ 255, 255, 255, 51 });
    frontend_theme.prompt.content.set_font_family("Fredoka");
    frontend_theme.prompt.controls.set_background_color(Color{ 85, 145, 223, 255 });
    frontend_theme.prompt.controls.set_border_top_color(Color{ 255, 255, 255, 25 });
    ...
    frontend_theme.prompt.button.normal.set_color(Color{ 255, 255, 255, 255 });
    frontend_theme.prompt.button.normal.set_background_color(Color{ 137, 180, 232, 255 });
    frontend_theme.prompt.button.normal.set_border_color(Color{ 143, 186, 237, 255 });
    frontend_theme.prompt.button.normal.set_font_family("Fredoka");
    frontend_theme.prompt.button.hover.set_color(Color{ 255, 255, 255, 255 });
    frontend_theme.prompt.button.hover.set_background_color(purple_accent);
    frontend_theme.prompt.button.hover.set_border_color(purple_accent);
